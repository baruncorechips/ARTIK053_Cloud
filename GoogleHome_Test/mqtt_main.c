...
#define DEVICE_ID "6f8fc5bd4a944c669b34013715b90d61" //FIX
#define DEVICE_TOKEN "25d651e1a3aa48b7885c83a16c9f6e24" // FIX
#define ACTION_TOPIC "/v1.1/actions/6f8fc5bd4a944c669b34013715b90d61" // FIX
#define MESSAGE_TOPIC "/v1.1/messages/6f8fc5bd4a944c669b34013715b90d61" //FIX
...
void onMessage(void* client, mqtt_msg_t *msg)
{
	...
	if (strstr(buf,"setOn") != NULL) gpio_write(PIN_D2,HIGH);
	else if (strstr(buf,"setOff") != NULL) gpio_write(PIN_D2,LOW);
}
...
int main(int argc, char *argv[])
{
	...
	while (mqttSubscribe == false )
	{
		...
		while (1)
		{
			...
			char tempBuf[20];
			sprintf(tempBuf,"\"Brightness\":%d", read_adc(0)); strcat(str,tempBuf); strcat(str,",");
			sprintf(tempBuf,"\"Temp\":%d", read_adc(1)); strcat(str,tempBuf); strcat(str,",");
			sprintf(tempBuf,"\"aaasd\":%d", read_adc(2)); strcat(str,tempBuf); strcat(str,"}}");
			//strcat(str,",");
